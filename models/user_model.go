...
type UserModel struct {
	...
	Articles    []ArticleModel   `gorm:"foreignKey:UserID" json:"-"`                                                                       //publish articles
	Collections []ArticleModel   `gorm:"many2many:user_article_collection_models;joinForeignKey:UserID;JoinReferences:ArticleID" json:"-"` //collect articles
}
